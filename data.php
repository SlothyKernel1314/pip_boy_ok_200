<section class="core-display" id="data-section">
    <div class="menu-container data-container">
        <div class="menu-attributes data-attributes">
            ...
            <div class="menu-attribute-box data-attribute-box" id="data-attribute-box-data_6">
                <p class="menu-attribute data-attribute">Data 6</p>
            </div>
            <div class="menu-attribute-box data-attribute-box" id="data-attribute-box-data_7">
                <p class="menu-attribute data-attribute">Data 7</p>
            </div>
        </div>
        <div class="menu-right-column data-right-column">
            ...
            <p class="data-attribute-description" id="data-attribute-description-data_3">
                ...
                Email : cyrilberthout@gmail.com<br /><br />
            </p>
            ...
            <p class="data-attribute-description" id="data-attribute-description-data_6">
                Desc 6
            </p>
            <p class="data-attribute-description" id="data-attribute-description-data_7">
                Desc 7
        </div>
    </div>
</section>